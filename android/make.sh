...
export APP_NAME_RELEASE="Kaslik Kart Rush"
export PACKAGE_NAME_RELEASE="com.kaslikservices.kaslikkartrush"
export PACKAGE_CLASS_NAME_RELEASE="com/kaslikservices/kaslikkartrush"
export APP_DIR_NAME_RELEASE="kaslik-kartrush"
...
export APP_NAME_BETA="Kaslik Kart Rush Beta"
export PACKAGE_NAME_BETA="com.kaslikservices.kaslikkartrush.beta"
export PACKAGE_CLASS_NAME_BETA="com/kaslikservices/kaslikkartrush/beta"
export APP_DIR_NAME_BETA="kaslik-kartrush-beta"
...
export APP_NAME_DEBUG="Kaslik Kart Rush Debug"
export PACKAGE_NAME_DEBUG="com.kaslikservices.kaslikkartrush.debug"
export PACKAGE_CLASS_NAME_DEBUG="com/kaslikservices/kaslikkartrush/debug"
export APP_DIR_NAME_DEBUG="kaslik-kartrush-debug"
...
echo "    <style name=\"Theme.KaslikSplashScreen\" parent=\"android:style/Theme.Holo\">" >> "$STYLES_FILE"
...
PO_EXTRACT_ERROR_MSG_STR="Check remaining device space or reinstall Kaslik Kart Rush."
PO_QUIT="po_quit"
PO_QUIT_STR="Quit"
...
sed -i "s/package com.kaslikservices.kaslikkartrush;/package $PACKAGE_NAME;/g" \
       "$DIRNAME/src/main/java/KaslikAds.java"
